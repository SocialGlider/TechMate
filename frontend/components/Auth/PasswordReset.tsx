...
const PasswordReset = () => {
    ...
    <div className='h-screen flex items-center justify-center flex-col'>
      ...
      <input type='number' placeholder='Enter OTP' className='block w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%] xl:w-[30%] mx-auto px-6 py-3 bg-gray-300 rounded-lg no-spinner outline-none'
      value={otp}
